!
! Extracted from Marcus Comstedt's Example Software
...
_start:
    ...
    ! (P2 is "privileged mode only, no cache")
...
.loop:
    ...
    ! Execute user code
    mov.l mainaddr, r0
    ! mov.l stack, r15 XXX I don't know how the stack is going to be set up
    jmp @r0
    mov r1, r0
